...
public class WhichRoute_Generator : MonoBehaviour
{
    /////////////////////////////////////////////////////////////
    ...
    private void Awake()
    {
        ...
        layoutPrefab = Resources.Load<GameObject>("Prefabs/Gameplay/Environment/SceneTerrainPrefabs/WhichRouteLayout");
        ...
        world.GetComponent<BoxCollider2D>().size = new Vector2(500.08678f, 500.9391f);
        ...
        player.transform.position = new Vector3(-3, -16, 0);
