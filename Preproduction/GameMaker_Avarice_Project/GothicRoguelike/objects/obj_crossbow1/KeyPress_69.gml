...
if(layer != 2){
	if (distance_to_object(obj_dummy) <= 50)
	{
		if(!global.hasCrossbow){
			...
			global.inventoryList[global.arrayCount] = spr_crossbow;
			global.arrayCount += 1;
		}
